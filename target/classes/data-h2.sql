...
DROP TABLE IF EXISTS TRAINEE_BATCH;
CREATE TABLE TRAINEE_BATCH(
	trainee_id INT(10) REFERENCES TRAINEE (trainee_id),
	batch_id INT(10)
);
--------------------------------------------------------
...
CREATE SEQUENCE IF NOT EXISTS TRAINEE_ID_SEQUENCE MINVALUE 1 INCREMENT BY 1 START WITH 1;
DROP SEQUENCE IF EXISTS USER_ID_SEQUENCE;
CREATE SEQUENCE IF NOT EXISTS USER_ID_SEQUENCE MINVALUE 1 INCREMENT BY 1 START WITH 1;
DROP SEQUENCE IF EXISTS TB_ID_SEQUENCE;
CREATE SEQUENCE IF NOT EXISTS TB_ID_SEQUENCE MINVALUE 1 INCREMENT BY 1 START WITH 1;
